...
int register_com_quester_android_PlatformLibrary_scard_SCardManager(JNIEnv* env)
{
    return jniRegisterNativeMethods(env, "com/quester/android/platform_library/scard/SCardManager",
